...
extern char		flagCompression;
extern bool		flagDualDestinies;
extern bool		flagOverwrite;
extern bool		flagIgnoreManifest;
extern string	flagOutputFile;
extern bool		flagQuiet;
extern char		flagVerbose;